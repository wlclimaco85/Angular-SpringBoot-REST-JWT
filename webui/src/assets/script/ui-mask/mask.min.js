                ...
                return {
                    ...
                    compile: function uiMaskCompilingFunction() {
                        ...
                        return function uiMaskLinkingFunction(scope, iElement, iAttrs, controller) {
                            ...
                            const REG_DASH = /\_/g, REG_FINAL_DOT = /\.$/g;
                            
                            var includeMask = iAttrs.hasOwnProperty('skIncludeMask');
                            var prevBlurValue = iElement.val();                                    
                            var preventFillMask = iAttrs.skPreventFillMask == 'true';
                            ...
                            function formatter(fromModelValue) {
                                ...
                                value = unmaskValue(angular.isDefined(fromModelValue) ? fromModelValue : '');
                            ...
                            function fillWithDefatult(unmaskedValue) {
                                if (iAttrs.skFillLeftFromRight && unmaskedValue.length > 0) {
                                    var defaultChar = getDefaultChar();

                                    while((maskCaretMap.length - 1) - unmaskedValue.length > 0){
                                        unmaskedValue = defaultChar + unmaskedValue;
                                    }
                                }
                            ...
                            function getDefaultChar() {
                                return iAttrs.skDefaultChar || '0';
                            }

                            function maskValue(unmaskedValue, preventFill, preventMask) {
                                var valueMasked = '',
                                        maskCaretMapCopy = maskCaretMap.slice();

                                if (!(preventFill === true) && !preventMask) {
                                    unmaskedValue = fillWithDefatult(unmaskedValue);
                                }
                            ...
                            function removeMaskFiil(valueMasked){
                                valueMasked = valueMasked.replace(REG_DASH, '');

                                while(REG_FINAL_DOT.test(valueMasked)){
                                    valueMasked = valueMasked.replace(REG_FINAL_DOT, '');
                                }
                            ...
                            function blurHandler() {
                                ...
                                if (value !== prevBlurValue) {
                                    if (value.length > 0) {
                                        var changed = false;
                                        var maskCaretMapCopy = maskCaretMap.slice();

                                        while((maskCaretMapCopy.length - 1) - value.length > 0){
                                            value = value + getDefaultChar();
                                            changed = true;
                                        }
                            ...
                            function eventHandler(e) {
                                ...
                                var preventFill = 'input-keyup-click-focus'.indexOf(eventType) > -1;

                                // Update values
                                valMasked = maskValue(valUnmasked, preventFill, eventType === 'focus');
                                ...
                                setCaretPosition(this, caretPos, eventType === 'focus');
                            }
                            ...
                            function groupValue(value) {
                                var unmaskedValue = fillWithDefatult(unmaskValue(value));
                                var maskCaretMapCopy = maskCaretMap.slice();
                                ...
                                angular.forEach(maskPlaceholder.split(''), function(chr, i) {
                                    if (unmaskedValue.length && i === maskCaretMapCopy[0]) {
                                        var currChar = unmaskedValue.charAt(0);
                            ...
                            function getCaretPosition(input) {
                                ...
                                if (!isFocused(iElement[0])) {
                                    ...
                                    if (angular.isDefined(value)) {
                                        var groupedValue = groupValue(value);
                                        var caretPos = -1;

                                        for (var i = 0, len = groupedValue.length; i < len; i++) {
                                            var currGroup = groupedValue[i];

                                            if (Number(currGroup) > 0) {
                                                if (caretPos == -1) {
                                                    caretPos = 0;
                                                }

                                                caretPos += (currGroup.length + 1); //Assumimos a marcara com 1 caractere apenas
                                            } else {
                                                if (caretPos == -1) {
                                                    caretPos = 0;
                                                }
                            ...
                            function setCaretPosition(input, pos, forceFocus) {
                                if (!input)
                                    return 0;
                                ...
                                if (input.setSelectionRange) {
                                    if (isFocused(iElement[0]) || forceFocus) {
                                        input.focus();
                                        input.setSelectionRange(pos, endPos);
                                    }
                                }
