package com.app.api.notaFiscal;
...
import com.app.model.NFe.TNFe;
import com.app.model.NFe.lerXML_JAXB;
...
public class NotaFiscalController {
  ...
  @ApiOperation(value = "List of notaFiscal", response = CustomerResponse.class)
  ...
  public CustomerResponse getCustomersByPage(
    ...
    @RequestMapping(value = "/notaFiscal", method = RequestMethod.POST, produces = {"application/json"})
    ...
    @RequestMapping(value = "/notaFiscal/{customerId}", method = RequestMethod.DELETE, produces = {"application/json"})
    ...
    @ApiOperation(value = "Delete a customer", response = OperationResponse.class)
    @RequestMapping(value = "/notaFiscal/insert", method = RequestMethod.GET, produces = {"application/json"})
    public List<TNFe> getAuthenticatedUserAll(HttpServletRequest request) {
    //	databaseDinamic.clearTables();
    	List<TNFe> sss = lerXML_JAXB.initNFE();
    	
    	//List<TNFe> sssdd= notaFiscalService.insertUser(sss);
    	//List<TNFe> sssdds= notaFiscalService.findAll();
        return new ArrayList<TNFe>();
    }
